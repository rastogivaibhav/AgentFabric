...
def main():
 ...
 for seed in range(args.runs):
  hist=[];t=0
  # initial validated model: three observed samples/action at safe states
  for st in SAFE:
  ...
  # world changes only for A4; first post-change observation should contest old rule
  ...
  # two more post-change observations: second training + held-out validation of replacement
